  ...
  <div v-if="!homeType">
    ...
    <div class="content" v-show="isUserSkeleton">
      ...
      <div class="pop-contact" v-show="friendState == 1">
        ...
        <div class="phone">
          <svg t="1689687311236" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="12916" width="15" height="15">
            <path
              ...
              p-id="12917" fill="#ffffff"></path>
          </svg>
        </div>
        <div class="video">
          <svg t="1689687973398" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="17502" width="15" height="15">
            <path
      ...
      <el-skeleton animated>
        <template #template>
          <div class="main" style="display:flex;justify-content: center; margin: 80px auto 0;">
            <div class="group-info-one" style="display: flex;align-item: center; justify-content: center;border: none;">
              <el-skeleton-item variant="circle" class="user-pic" />
              <div class="info-left"
                style="display: flex;align-item: center; justify-content: center;padding: 0 20px 0;box-sizing: border-box;">
