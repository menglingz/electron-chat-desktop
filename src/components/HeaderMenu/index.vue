<template>
    <div class="header-menu no-drag" :style="!proxy.isMac ? 'padding-right: 120px;' : 'padding-right: 20px;'">
        <!-- 语言通话 -->
        <svg @click="voiceCall" @mouseover="voiceActive = true" @mouseout="voiceFlag ? '' : voiceActive = false"
            t="1699165279771" style="transform: rotateY(180deg);" class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="2973" width="25" height="25">
            <path
        ...
        <!-- 视频通话 -->
        <svg @click="videoCall" @mouseover="videoActive = true" @mouseout="videoFlag ? '' : videoActive = false" t="1699165177594" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="4522" width="25" height="25">
            <path
            ...
            <path d="M208 360h112c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H208c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8z" p-id="4524"
                :fill="videoActive ? '#50abf8' : '#4F4F4F'"></path>
        </svg>
        <!-- 屏幕共享 -->
        <svg @click="screenShare" @mouseover="screenActive = true" @mouseout="screenFlag ? '' : screenActive = false" t="1699164753923" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- 更多 -->
        <svg @click="more" @mouseover="moreActive = true" @mouseout="moreFlag ? '' : moreActive = false" t="1699165777338" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
// 语音通话
const voiceCall = () => {
    ipcRenderer.send('open-telephone', { type: 'voice', url: '/telephone/voice' })
}
...
// 视频通话
const videoCall = () => {
    ipcRenderer.send('open-telephone', { type: 'video', url: '/telephone/video' })
}
...
// 屏幕共享
const screenShare = () => {
    ipcRenderer.send('open-screen-choose', { type: 'screen', url: '/telephone/screen' })
}
