...
export const reqSearch = (keyword: string) =>
  request<any, KeywordResult>({ url: API.SEARCH_URL, method: 'get', params: { keyword } });
// 获取好友列表接口
export const reqGetFriendList = (userId: string) =>
  request<any, GetFriendListResponseData>({ url: API.GETFRIENDLIST_URL, method: 'get', params: { userId } });
// 获取群列表接口
export const reqGetGroupList = (userId: string) =>
  request<any, GetGroupListResponseData>({ url: API.GETGROUPLIST_URL, method: 'get', params: { userId } });
// 获取用户主页信息接口
export const reqGetUserContactHomeInfo = (ids: UserIds) =>
  request<any, UserContactHomeResponseData>({ url: API.GETUSERCONTACTHOMEINFO_URL, method: 'get', params: ids });
// 获取群主页信息接口
export const reqGetGroupContactHomeInfo = (ids: GroupIds) =>
  request<any, GroupContactHomeResponseData>({ url: API.GETGROUPCONTACTHOMEINFO_URL, method: 'get', params: ids });
// 发送好友申请接口
...
export const reqGetFriendNoagreeList = (userId: string) =>
  request<any, FriendNoagreeListResponseData>({ url: API.GETFRIENDNOAGREE_URL, method: 'get', params: { userId } });
// 获取群申请列表接口
export const reqGetGroupNoagreeList = (userId: string) =>
  request<any, GroupNoagreeListResponseData>({ url: API.GETGROUPNOAGREE_URL, method: 'get', params: { userId } });
// 同意好友申请接口
