        ...
        <div class="apply-message-content">
          <div class="apply-message-friend" @click="handleShowApplyMessage(0)">好友通知
            <div class="right-wrap">
              <div class="dot" v-if="contactStore.friendContactNum != 0">{{ contactStore.friendContactNum > 99 ? '99+' : contactStore.friendContactNum }}</div>
              <el-icon>
                <ArrowRight />
              </el-icon></div>
            </div>
          <div class="apply-message-group" @click="handleShowApplyMessage(1)">群通知
            <div class="right-wrap">
              <div class="dot" v-if="contactStore.groupContactNum != 0">{{ contactStore.groupContactNum > 99 ? '99+' : contactStore.groupContactNum }}</div>
              <el-icon>
                <ArrowRight />
              </el-icon></div>
            </div>
